...
## Vision
A hands-on project to master assembly language (x86_64 & AArch64) by developing high-performance, dependency-free CLI tools for Linux system monitoring.
...
* **Portability & Simplicity:** Create binaries that run natively on headless Linux environments (amd64 and arm64) without external library requirements (libc-free).
...
* **Stack:** GNU Assembler (`as`), `ld` (GNU Linker), and the Linux x86_64 and AArch64 ABIs.
